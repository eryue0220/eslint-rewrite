...
## [2.0.0](https://github.com/eryue0220/eslint-rewrite/compare/core-v1.0.0...core-v2.0.0) (2025-12-03)


### ⚠ BREAKING CHANGES

* Remove deprecated RuleContext methods ([#263](https://github.com/eryue0220/eslint-rewrite/issues/263))
* remove deprecated `nodeType` property ([#265](https://github.com/eryue0220/eslint-rewrite/issues/265))
* Require Node.js ^20.19.0 || ^22.13.0 || >=24 ([#297](https://github.com/eryue0220/eslint-rewrite/issues/297))
* Add getLoc/getRange to SourceCode interface ([#89](https://github.com/eryue0220/eslint-rewrite/issues/89))

### Features

* Add `Language.defaultLanguageOptions` ([#123](https://github.com/eryue0220/eslint-rewrite/issues/123)) ([1ecf0f8](https://github.com/eryue0220/eslint-rewrite/commit/1ecf0f88808a7629e06e949dea8eb1ec4fd2f472))
* add CommonJS `core` types ([#102](https://github.com/eryue0220/eslint-rewrite/issues/102)) ([6caa5e1](https://github.com/eryue0220/eslint-rewrite/commit/6caa5e1408d94387277abc65ff2b6d6b1d005488))
...
* add core types for language-specific rule definitions ([#178](https://github.com/eryue0220/eslint-rewrite/issues/178)) ([fd9b571](https://github.com/eryue0220/eslint-rewrite/commit/fd9b571554085cb5ea9f9831a38650a49dfebb32))
...
* Add eslint/core package ([#68](https://github.com/eryue0220/eslint-rewrite/issues/68)) ([e3d309d](https://github.com/eryue0220/eslint-rewrite/commit/e3d309d93fefe4e10f40568e89f380159c7f63d3))
* Add extendable config types ([#210](https://github.com/eryue0220/eslint-rewrite/issues/210)) ([3089754](https://github.com/eryue0220/eslint-rewrite/commit/3089754848c1acd30368424271810cc9703a6cd4))
* Add getLoc/getRange to SourceCode interface ([#89](https://github.com/eryue0220/eslint-rewrite/issues/89)) ([d51f979](https://github.com/eryue0220/eslint-rewrite/commit/d51f9791aecd9aa80136a0926e57549df9e25ab3))
* Add Language#normalizeLanguageOptions() ([#131](https://github.com/eryue0220/eslint-rewrite/issues/131)) ([3591a78](https://github.com/eryue0220/eslint-rewrite/commit/3591a7805a060cb130d40d61f200431b782431d8))
* Add meta.language and meta.dialects to RuleDefinition ([#156](https://github.com/eryue0220/eslint-rewrite/issues/156)) ([dac0387](https://github.com/eryue0220/eslint-rewrite/commit/dac0387fc3dd7e74811ae045ab782c70366bb14c))
* Add more type definitions ([#81](https://github.com/eryue0220/eslint-rewrite/issues/81)) ([df3263b](https://github.com/eryue0220/eslint-rewrite/commit/df3263b336b663b22be32bf0c499a70b378b5021))
...
* Add rule types ([#110](https://github.com/eryue0220/eslint-rewrite/issues/110)) ([ffa176f](https://github.com/eryue0220/eslint-rewrite/commit/ffa176f0c80c14c8ba088d2ba359af4b2805c4f5))
* Check messageIds in context.report() ([#140](https://github.com/eryue0220/eslint-rewrite/issues/140)) ([1c9ca4d](https://github.com/eryue0220/eslint-rewrite/commit/1c9ca4d0a4726218948a92ebc2e8be7a13d224d4))
* export additional core types ([#304](https://github.com/eryue0220/eslint-rewrite/issues/304)) ([5ccde5b](https://github.com/eryue0220/eslint-rewrite/commit/5ccde5bc9442c572d740c063fcb50392bf13c3db))
...
* Require Node.js ^20.19.0 || ^22.13.0 || &gt;=24 ([#297](https://github.com/eryue0220/eslint-rewrite/issues/297)) ([acc623c](https://github.com/eryue0220/eslint-rewrite/commit/acc623c807bf8237a26b18291f04dd99e4e4981a))
* Set type for RuleDefinition.defaultOptions ([#173](https://github.com/eryue0220/eslint-rewrite/issues/173)) ([d5806df](https://github.com/eryue0220/eslint-rewrite/commit/d5806dfe5c2af849b84f39e3eb0300aaa7c29092))
* Update RuleDefinition for frozen and deprecations ([#149](https://github.com/eryue0220/eslint-rewrite/issues/149)) ([4964322](https://github.com/eryue0220/eslint-rewrite/commit/49643228d230f2d0edce6d2a310ccf3131b72d89))
* Update RuleDefinition with `meta.defaultOptions` ([#150](https://github.com/eryue0220/eslint-rewrite/issues/150)) ([e9a987e](https://github.com/eryue0220/eslint-rewrite/commit/e9a987e8d92a6383e9782332e515aa2a719a18af))


### Bug Fixes

* Allow RuleConfig to have array with just severity ([#228](https://github.com/eryue0220/eslint-rewrite/issues/228)) ([c5f92fa](https://github.com/eryue0220/eslint-rewrite/commit/c5f92fa147ecad74164266c374f47ee217c7ccb7))
...
* Make meta.replacedBy read only ([#146](https://github.com/eryue0220/eslint-rewrite/issues/146)) ([7dfc0d9](https://github.com/eryue0220/eslint-rewrite/commit/7dfc0d92e617108c0e9493f09db3f86919e02fd1))
* non-optional properties in generic interfaces ([#132](https://github.com/eryue0220/eslint-rewrite/issues/132)) ([d0b2e70](https://github.com/eryue0220/eslint-rewrite/commit/d0b2e705c49709cfb92a9110c65cd628c91aaa29))
...
* remove deprecated `nodeType` property ([#265](https://github.com/eryue0220/eslint-rewrite/issues/265)) ([7d6a2a8](https://github.com/eryue0220/eslint-rewrite/commit/7d6a2a8dfb73203790403dea240669b6ab543340))
* Remove deprecated RuleContext methods ([#263](https://github.com/eryue0220/eslint-rewrite/issues/263)) ([0455323](https://github.com/eryue0220/eslint-rewrite/commit/0455323682227ba2e219645a49c20085ab76cbf0))
* remove unsupported `nodeType` from types ([#268](https://github.com/eryue0220/eslint-rewrite/issues/268)) ([d800559](https://github.com/eryue0220/eslint-rewrite/commit/d8005593158f55ba32f5279f3385db95ab87075a))
* require `fix` in suggestion objects ([#298](https://github.com/eryue0220/eslint-rewrite/issues/298)) ([02bac50](https://github.com/eryue0220/eslint-rewrite/commit/02bac50b8a053f12a97afbe65b126ccd2c469d9e))
* Types to align with older ESLint types ([#155](https://github.com/eryue0220/eslint-rewrite/issues/155)) ([664740a](https://github.com/eryue0220/eslint-rewrite/commit/664740a8d4a93bee896cec3a661bf2072e893e24))
* Update RuleDefinition type ([#138](https://github.com/eryue0220/eslint-rewrite/issues/138)) ([0a0ea6f](https://github.com/eryue0220/eslint-rewrite/commit/0a0ea6fbac827b354ee18f5b10eefad2bc0794f7))
