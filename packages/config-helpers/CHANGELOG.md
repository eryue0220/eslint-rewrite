...
## [0.6.0](https://github.com/eryue0220/eslint-rewrite/compare/config-helpers-v0.5.0...config-helpers-v0.6.0) (2025-12-03)
...
* add validation for `plugins`  in isLegacyConfig ([#292](https://github.com/eryue0220/eslint-rewrite/issues/292)) ([74f9427](https://github.com/eryue0220/eslint-rewrite/commit/74f9427b47de313582793ab6fc4c723f1526fdc0))
...
* use flat config when eslintrc config does not exist ([#288](https://github.com/eryue0220/eslint-rewrite/issues/288)) ([ddc8577](https://github.com/eryue0220/eslint-rewrite/commit/ddc857781bacab1cdd7c540e599d3ed968607a09))
