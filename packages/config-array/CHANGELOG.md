...
## [0.22.0](https://github.com/eryue0220/eslint-rewrite/compare/config-array-v0.21.1...config-array-v0.22.0) (2025-10-21)
...
* The following workspace dependencies were updated
  * dependencies
    * @eslint/object-schema bumped from ^2.1.7 to ^2.2.0
